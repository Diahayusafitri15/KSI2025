...
require 'koneksi.php'; // Menggunakan file koneksi.php yang baru untuk koneksi ke MySQL/Laragon

// Ambil data mahasiswa
// $pdo berasal dari koneksi.php
...
<body>
    ...
    <div class="container">
        ...
        <p><a href="tambah.php" class="btn btn-success mb-3">Tambah Data Baru</a></p>
        
        <p class="text-muted">Contoh tampilan data mahasiswa menggunakan
        PHP native + Bootstrap</p>
